...
from tracking.models.order_processing_time_estimated_pickup_predict_request import (
    OrderProcessingTimeEstimatedPickupPredictRequest,
)


class EstimatedPickupPredictRequest(BaseModel):
    """
    ...
    order_processing_time: Optional[OrderProcessingTimeEstimatedPickupPredictRequest] = None

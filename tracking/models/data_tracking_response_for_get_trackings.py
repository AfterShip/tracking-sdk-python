...
from tracking.models.pagination_data_tracking_response_for_get_trackings import (
    PaginationDataTrackingResponseForGetTrackings,
)
from tracking.models.tracking import Tracking


class DataTrackingResponseForGetTrackings(BaseModel):
    """
    DataTrackingResponseForGetTrackings
    """  # noqa: E501

    pagination: Optional[PaginationDataTrackingResponseForGetTrackings] = None

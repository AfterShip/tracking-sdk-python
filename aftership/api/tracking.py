...
class TrackingApi(ApiClient):
    ...
    def create_tracking(
        ...
        **kwargs) -> CreateTrackingResponse:
        ...
        """
        url = "/tracking/2024-01/trackings"
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-01/trackings/{tracking_id}"
    ...
    def delete_tracking_by_slug_tracking_number(
        ...
        **kwargs) -> DeleteTrackingBySlugTrackingNumberResponse:
        """
        Delete a tracking.
        ...
        """
        url = f"/tracking/2024-01/trackings/{slug}/{tracking_number}"
        params_keys = {
    ...
    def get_tracking_by_slug_tracking_number(
        ...
        **kwargs) -> GetTrackingBySlugTrackingNumberResponse:
        """
        Get tracking results of a single tracking.
        :param slug: str. Tracking slug.
        :param tracking_number: str. Tracking number.
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-01/trackings/{tracking_id}/mark-as-completed"
    ...
    def mark_tracking_completed_by_slug_tracking_number(
        self,
        slug: Annotated[str, Field(min_length=1)], tracking_number: Annotated[str, Field(min_length=1)], 
        mark_tracking_completed_by_slug_tracking_number_request: Union[MarkTrackingCompletedBySlugTrackingNumberRequest, dict], 
        **kwargs) -> MarkTrackingCompletedBySlugTrackingNumberResponse:
        """
        Mark a tracking as completed. The tracking won't auto update until retrack it.
        :param slug: str. Tracking slug.
        :param tracking_number: str. Tracking number.
        ...
        :param kwargs:
            ...
            query params:
                ...
                **tracking_state**: str. Additional field required by some carriers to retrieve the tracking info. The state/province of the recipient’s address. Refer to our article on  for more details.
        """
        url = f"/tracking/2024-01/trackings/{slug}/{tracking_number}/mark-as-completed"
        params_keys = {
            "tracking_account_number",
            "tracking_origin_country",
            "tracking_destination_country",
        ...
        if not isinstance(body, dict):
            body = mark_tracking_completed_by_slug_tracking_number_request.model_dump(exclude_none=True)
        body = json.dumps(body)
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-01/trackings/{tracking_id}/retrack"
    ...
    def retrack_tracking_by_slug_tracking_number(
        ...
        **kwargs) -> RetrackTrackingBySlugTrackingNumberResponse:
        """
        Retrack an expired tracking. Max 3 times per tracking.
        :param slug: str. Tracking slug.
        :param tracking_number: str. Tracking number.
        :param kwargs:
            ...
            query params:
                ...
                **tracking_state**: str. Additional field required by some carriers to retrieve the tracking info. The state/province of the recipient’s address. Refer to our article on  for more details.
        """
        url = f"/tracking/2024-01/trackings/{slug}/{tracking_number}/retrack"
        params_keys = {
            "tracking_account_number",
            "tracking_origin_country",
            "tracking_destination_country",
    ...
    def update_tracking_by_slug_tracking_number(
        self,
        slug: Annotated[str, Field(min_length=1)], tracking_number: Annotated[str, Field(min_length=1)], 
        update_tracking_by_slug_tracking_number_request: Union[UpdateTrackingBySlugTrackingNumberRequest, dict], 
        **kwargs) -> UpdateTrackingBySlugTrackingNumberResponse:
        """
        Update a tracking.
        :param slug: str. Tracking slug.
        :param tracking_number: str. Tracking number.

...
from aftership.request import ApiClient, validate_params
...
class NotificationApi(ApiClient):
    ...
    def add_notification_by_slug_tracking_number(
        self,
        slug: Annotated[str, Field(min_length=1)], tracking_number: Annotated[str, Field(min_length=1)], 
        add_notification_by_slug_tracking_number_request: Union[AddNotificationBySlugTrackingNumberRequest, dict], 
        **kwargs) -> AddNotificationBySlugTrackingNumberResponse:
        """
        ...
        """
        url = f"/tracking/2024-01/notifications/{slug}/{tracking_number}/add"
        params_keys = {
        ...
        return AddNotificationBySlugTrackingNumberResponse().from_dict(result)

    @validate_params
    def add_notification_by_tracking_id(
        self,
        tracking_id: Annotated[str, Field(min_length=1)], 
        add_notification_by_tracking_id_request: Union[AddNotificationByTrackingIdRequest, dict], 
        **kwargs) -> AddNotificationByTrackingIdResponse:
        """
        Add notification receivers to a tracking number.
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-01/notifications/{tracking_id}/add"
        ...
        return AddNotificationByTrackingIdResponse().from_dict(result)

    @validate_params
    def delete_notification_by_slug_tracking_number(
        self,
        slug: Annotated[str, Field(min_length=1)], tracking_number: Annotated[str, Field(min_length=1)], 
        delete_notification_by_slug_tracking_number_request: Union[DeleteNotificationBySlugTrackingNumberRequest, dict], 
        **kwargs) -> DeleteNotificationBySlugTrackingNumberResponse:
        """
        ...
        :param kwargs:
            ...
            query params:
                ...
                **tracking_state**: str. Additional field required by some carriers to retrieve the tracking info. The state/province of the recipient’s address. Refer to our article on  for more details.
        """
        url = f"/tracking/2024-01/notifications/{slug}/{tracking_number}/remove"
        params_keys = {
            "tracking_account_number",
            "tracking_origin_country",
            "tracking_destination_country",
        ...
        result = self._request("POST", url=url, params=params, body=body, **kwargs)
        return DeleteNotificationBySlugTrackingNumberResponse().from_dict(result)

    @validate_params
    def delete_notification_by_tracking_id(
        self,
        tracking_id: Annotated[str, Field(min_length=1)], 
        delete_notification_by_tracking_id_request: Union[DeleteNotificationByTrackingIdRequest, dict], 
        **kwargs) -> DeleteNotificationByTrackingIdResponse:
        """
        Remove notification receivers from a tracking number.
        :param tracking_id: str. tracking id.
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-01/notifications/{tracking_id}/remove"
        ...
        result = self._request("POST", url=url, body=body, **kwargs)
        return DeleteNotificationByTrackingIdResponse().from_dict(result)
    ...
    def get_notification_by_slug_tracking_number(
        ...
        **kwargs) -> GetNotificationBySlugTrackingNumberResponse:
        """
        ...
        :param kwargs:
            ...
            query params:
                ...
                **tracking_state**: str. Additional field required by some carriers to retrieve the tracking info. The state/province of the recipient’s address. Refer to our article on  for more details.
        """
        url = f"/tracking/2024-01/notifications/{slug}/{tracking_number}"
        params_keys = {
            "tracking_account_number",
            "tracking_origin_country",
            "tracking_destination_country",
        ...
        return GetNotificationBySlugTrackingNumberResponse().from_dict(result)
    ...
    def get_notification_by_tracking_id(
        ...
        **kwargs) -> GetNotificationByTrackingIdResponse:
        """
        Get contact information for the users to notify when the tracking changes. Please note that only customer receivers will be returned. Any `email`, `sms` or `webhook` that belongs to the Store will not be returned.
        :param tracking_id: str. tracking id.
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-01/notifications/{tracking_id}"

        result = self._request("GET", url=url, **kwargs)
        return GetNotificationByTrackingIdResponse().from_dict(result)

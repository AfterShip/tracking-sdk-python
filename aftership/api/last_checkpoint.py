...
class LastCheckpointApi(ApiClient):
    ...
    def get_checkpoint_by_slug_tracking_number(
        ...
        **kwargs) -> GetCheckpointBySlugTrackingNumberResponse:
        """
        ...
        """
        url = f"/tracking/2024-01/last_checkpoint/{slug}/{tracking_number}"
        params_keys = {
            "fields",
            "lang",
    ...
    def get_checkpoint_by_tracking_id(
        ...
        **kwargs) -> GetCheckpointByTrackingIdResponse:
        """
        Return the tracking information of the last checkpoint of a single tracking.
        ...
        :param kwargs:
            ...
            query params:
                ...
                **lang**: str. Support Chinese to English translation for `china-ems` and `china-post` only
        """
        url = f"/tracking/2024-01/last_checkpoint/{tracking_id}"
        params_keys = {
            "fields",
            "lang",
        }

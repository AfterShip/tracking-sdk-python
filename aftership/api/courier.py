...
class CourierApi(ApiClient):
    ...
    def detect_courier(
        ...
        **kwargs) -> DetectCourierResponse:
        ...
        """
        url = "/tracking/2024-01/couriers/detect"

...
from aftership.models.notification_request_v1 import NotificationRequestV1


class DeleteNotificationBySlugTrackingNumberRequest(BaseModel):
    """
    DeleteNotificationBySlugTrackingNumberRequest
    """  # noqa: E501
    notification: Optional[NotificationRequestV1] = None

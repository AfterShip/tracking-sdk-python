...
from aftership.models.tracking_update_tracking_by_id_request import TrackingUpdateTrackingByIdRequest
...
class UpdateTrackingByIdRequest(BaseModel):
    ...
    """  # noqa: E501
    tracking: Optional[TrackingUpdateTrackingByIdRequest] = None

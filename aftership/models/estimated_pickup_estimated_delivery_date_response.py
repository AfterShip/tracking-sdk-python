...
from aftership.models.order_processing_time_estimated_pickup_estimated_delivery_date_response import OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateResponse
...
class EstimatedPickupEstimatedDeliveryDateResponse(BaseModel):
    ...
    order_processing_time: Optional[OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateResponse] = None

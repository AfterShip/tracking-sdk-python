...
from aftership.models.order_processing_time_estimated_pickup_estimated_delivery_date_request import OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateRequest
...
class EstimatedPickupEstimatedDeliveryDateRequest(BaseModel):
    ...
    order_processing_time: Optional[OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateRequest] = None
